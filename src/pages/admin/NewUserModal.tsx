...
import { useAuth, useDepartment, useRole, useUser } from '../../hooks/contextHooks';
...
const NewUserModal = ({ closeNewUserModal, isNewUserModalOpen }: NewUserModalProps) => {
    ...
    return (
    <>
        <ModalBox open={isNewUserModalOpen} onClose={closeNewUserModal} width={600}>
            <Typography variant="h6" textAlign="center" marginBottom={2}>Create new User</Typography>
            <Form onSubmit={onSubmit} validationSchema={createUserSchema}>
                ...
                <Stack direction="row" justifyContent="center" spacing={2} mt={3}>
                    ...
                    <Button onClick={closeNewUserModal} variant='contained'>Cancel</Button>
                </Stack>
            </Form>
        </ModalBox>
    </>
