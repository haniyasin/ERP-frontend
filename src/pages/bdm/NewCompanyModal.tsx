...
const NewCompanyModal = ({ closeNewCompanyModal, isNewCompanyModalOpen }: NewCompanyModalProps) => {
    ...
    return (
    <>
        <ModalBox open={isNewCompanyModalOpen} onClose={closeNewCompanyModal} width={600}>
            <Typography variant="h6" textAlign="center" marginBottom={2}>Add new Company</Typography>
            <Form onSubmit={onSubmit} validationSchema={createCompanySchema}>
                ...
                <Stack direction="row" justifyContent="center" spacing={2} mt={3}>
                    ...
                    <Button onClick={closeNewCompanyModal} variant='contained'>Cancel</Button>
                </Stack>
            </Form>
        </ModalBox>
    </>
