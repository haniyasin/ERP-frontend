...
const PositionDashboard = () => {
    const [isEditPostionClicked, setIsEditPositionClicked] = useState<boolean>(false);
    ...
    return (
        <Container sx={{ marginTop: 8 }}>
          ...
          <Typography variant='h6' textAlign="center" marginBottom={2}>Position information</Typography>
          <Grid container direction="row" justifyContent="center" spacing={2}>
            <Grid item container direction="column" lg={12}>
              <Stack direction="row" justifyContent="center" spacing={2} mb={3}>
                <Button onClick={handlePositionDashboardClose} variant='contained'>Back</Button>
                <Button onClick={() => setIsEditPositionClicked(prev => !prev)} variant='contained'>Edit</Button>
              </Stack>
