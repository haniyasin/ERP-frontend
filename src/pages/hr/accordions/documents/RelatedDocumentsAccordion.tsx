...
const RelatedDocumentsAccordion = ({ employeeLeft }: RelatedDocumentsAccordionProps) => {
  const [isNewEmployeeDocumentModalOpen, setIsNewEmployeeDocumentModalOpen] = useState<boolean>(false);
    ...
    <Accordion elevation={0} defaultExpanded={false}>
      ...
      <AccordionDetails>
        <Stack direction="column" alignItems="center" spacing={2} sx={{ width: '100%' }}>
          <Button onClick={() => setIsNewEmployeeDocumentModalOpen(true)} variant="contained" disabled={employeeLeft}>
            New Document
          </Button>
