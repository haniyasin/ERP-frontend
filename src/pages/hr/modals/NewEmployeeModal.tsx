...
import { useAuth, useDepartment, useUser } from '../../../hooks/contextHooks';
...
const NewEmployeeModal = ({ isNewEmployeeModalOpen, closeNewEmployeeModal }: NewEmployeeModalProps) => {
  ...
  const onSubmit = (data: User) => {
    ...
    const inputData = {
        ...data,
        role: {id: 5},
        departments: data.departments.map(dep => { return {id: dep} }),
  ...
  return (
    <>
        <ModalBox open={isNewEmployeeModalOpen} onClose={closeNewEmployeeModal} width={600}>
            <Typography variant="h6" textAlign="center" marginBottom={2}>Add new Employee</Typography>
            <Form onSubmit={onSubmit} validationSchema={createEmployeeSchema}>
                <Typography textAlign='center' variant='subtitle1' mt={2}>Basic info</Typography>
                <Grid container direction="row" spacing={2} justifyContent="center">
                    <Grid item container direction="column" xs={6} alignContent="flex-end">
                ...
                <Typography textAlign='center' variant='subtitle1' mt={2}>Salary info</Typography>
                <Stack direction="row" justifyContent="center" spacing={2} >
                    ...
                    <Grid item container direction="column" lg={6} alignContent="flex-start">
                      <Stack direction="column" spacing={0} width={"85%"}>
                        <InputField
                          name="startDate"
                          label="Start Date"
                ...
                <Stack direction="row" justifyContent="center" spacing={2} mt={3}>
                    ...
                    <Button onClick={closeNewEmployeeModal} variant='contained'>Cancel</Button>
                </Stack>
            </Form>
        </ModalBox>
    </>
